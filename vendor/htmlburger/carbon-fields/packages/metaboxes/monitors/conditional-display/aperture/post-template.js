...
function getPostTemplateFromSelect( node ) {
	...
	// In Gutenberg for the "Default" templates is used an empty string.
	if ( value === 'default' ) {
		value = '';
	}
 ...
 */
addFilter( 'carbon-fields.conditional-display-post-templates.classic', 'carbon-fields/metaboxes', () => {
 ...
 */
addFilter( 'carbon-fields.conditional-display-post-templates.gutenberg', 'carbon-fields/metaboxes', () => {
	return pipe(
